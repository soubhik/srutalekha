...
public class TranscriptionThread extends Thread {
	...
	public String transcribe(String _path) {
		...
		try {
            ...
            r = new ClientHttpRequest("https://www.google.com/speech-api/full-duplex/v1/up?lang=" + lang + "&lm=dictation&client=chromium&key=AIzaSyDQwrtYR4C6Y1zvjikETPuml5NIlbDWkDw");
